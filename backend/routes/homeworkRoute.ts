...
import {getHomework, createHomework, editHomework, deleteHomework, ParentEditHomework, getAssignmentsToGradeCount, getGradedAssignmens} from '../controllers/homeworkController.js'
...
router.get('/graded-assignments', authenticateToken, authorizeRole(['TEACHER']), getGradedAssignmens)
